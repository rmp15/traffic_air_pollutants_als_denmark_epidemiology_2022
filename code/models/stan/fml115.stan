// main model (fml101) with adjusted prior on lambda~normal(0,100) 
// and same as fml112 but used longer iterations and warm-up
...
model {
  ...
  lambda ~ normal(0,100);                        // prior on lambda
