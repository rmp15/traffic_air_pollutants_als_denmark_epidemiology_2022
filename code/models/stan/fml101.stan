// main model
// based on dicsussions from https://groups.google.com/g/stan-users/c/UYuZYJOl5v0
...
# N_g = number obs in group
# D_g = number of cases in group
# xb = observation level linear predictor
